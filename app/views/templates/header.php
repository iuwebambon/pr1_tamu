                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <!-- <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="<?= BASEURL; ?>\files\assets\images\avatar-4.jpg" alt="Generic placeholder image">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="<?= BASEURL; ?>\files\assets\images\avatar-3.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="<?= BASEURL; ?>\files\assets\images\avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                        <span>Admin</span>
